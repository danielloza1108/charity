    ...
    <form:form cssClass="form--contact" method="post" modelAttribute="password">
        <div class="panelInput">
            <div class="form-group form-group panel">
                <h2>Stare hasło:</h2><form:input cssClass="panelInput" path="password"/>
            </div>
            <div class="form-group form-group panel">
                <h2>Nowe hasło:</h2><form:input cssClass="panelInput" path="newPassword"/>
            </div>
            <div class="form-group form-group panel">
                <h2>Powtórz nowe hasło:</h2><form:input cssClass="panelInput" path="reNewPassword"/>
            </div>
        </div>
